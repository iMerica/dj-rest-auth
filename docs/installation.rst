...
``https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=<YOUR CALLBACK URL>&prompt=consent&response_type=code&client_id=<YOUR CLIENT ID>&scope=openid&access_type=offline``


If you're using Implicit Grant, you can get token from folloing URL


``https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=<YOUR CALLBACK URL>&prompt=consent&response_type=token&client_id=<YOUR CLIENT ID>&scope=openid``
