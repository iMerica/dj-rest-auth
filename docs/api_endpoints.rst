...
- /dj-rest-auth/facebook/ (POST)
    ...
    .. note:: ``access_token`` OR ``code`` can be used as standalone arguments, see https://github.com/robertwt7/dj-rest-auth-social/blob/master/dj_rest_auth/registration/views.py
